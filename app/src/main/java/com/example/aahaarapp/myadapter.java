...
public class myadapter extends RecyclerView.Adapter<myadapter.myviewholder>
{
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, int position) {
        holder.tname.setText(datalist.get(position).getUserid());
        holder.ttype.setText(datalist.get(position).getTimestamp().toString());
        holder.tdescription.setText(datalist.get(position).getItems());
    }
